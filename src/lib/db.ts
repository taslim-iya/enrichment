...
export async function upsertCompanies(rawCompanies: Record<string, unknown>[]): Promise<void> {
  ...
  for (const raw of rawCompanies) {
    ...
    const mapped: Company = {
      ...
      profit: raw.profit as string | number | undefined,
      assets: raw.assets as string | number | undefined,
      equity: raw.equity as string | number | undefined,
      director: (raw.director || raw.contact_name) as string | undefined,
      ...
      contact_title: raw.contact_title as string | undefined,
